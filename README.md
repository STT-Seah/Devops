...
**Instructions**
  ...
  4.Create a workflow, click add file button and select create new file, be very specified when comes to naming the file.Type the proper directory in this format: .github/workflows/superlinter.yml(name whatever you want and copy and paste the code in the blank space to run.Warning: if workflow is not triggering which mean the format or spelling error to name th workflow file)
