...
**Instructions**
  ...
  The code (from superlinter.yml) paste, its purpose is to listen for a push event, when the push event happen, it's going to check our code and than run superlinter again to make sure it conforms to the linting standards.
